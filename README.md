...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://github.com/ceibo-it/terraform-aws-cloudfront-s3-cdn/releases).
...
```hcl
module "cdn" {
  source           = "git::https://github.com/ceibo-it/terraform-aws-cloudfront-s3-cdn.git?ref=master"
  namespace        = "cb"
  stage            = "prod"
  name             = "app"
  aliases          = ["assets.ceibo.it"]
